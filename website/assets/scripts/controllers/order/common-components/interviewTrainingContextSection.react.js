            ...
            <section id="context-section" className="two-columns">
                ...
                <div>
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="important-for-the-role" maxLength="480" />
                    ...
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="latest-interview" maxLength="480" />
                        <p className="field-error" data-check="max-length">{CR.i18nMessages["order.interviewTraining.assessmentInfo.contextSection.validation.textTooLong"]}</p>
                    </div>
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="need-for-improvement" maxLength="480" />
                        <p className="field-error" data-check="max-length">{CR.i18nMessages["order.interviewTraining.assessmentInfo.contextSection.validation.textTooLong"]}</p>
                    </div>
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="challenging-questions" maxLength="480" />
                        <p className="field-error" data-check="max-length">{CR.i18nMessages["order.interviewTraining.assessmentInfo.contextSection.validation.textTooLong"]}</p>
                    </div>
                </div>
            </section>);
