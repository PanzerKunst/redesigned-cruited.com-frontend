CR.Controllers.CartProductListItem = React.createClass({
    render() {
        ...
        const classes = classNames({
            ...
            "with-edition": this.props.product.code !== CR.Models.Product.codes.CV_REVIEW_CONSULT && this.props.product.code !== CR.Models.Product.codes.LINKEDIN_PROFILE_REVIEW_CONSULT && this.props.product.code !== CR.Models.Product.codes.INTERVIEW_TRAINING
        });
