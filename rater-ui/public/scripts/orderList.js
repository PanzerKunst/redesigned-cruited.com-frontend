...
/***/ function(module, exports, __webpack_require__) {
	...
	var AssessmentListController = {
	    ...
	    reactComponent: React.createClass({
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "ul",
	                        { className: "styleless" },
	                        this.state.ordersAssignedToMe.map(function (order) {
	                            return React.createElement(
	                                "li",
	                                { className: _this._cssClassForStatus(order.status) },
	                                React.createElement(
	                                    "section",
	                                    null,
	                                    _this._raterProfile(order.rater),
	                                    React.createElement(
	                                        "p",
	                                        null,
	                                        "#",
	                                    ...
	                                    _this._timeRemaining(order.paymentTimestamp),
	                                    React.createElement(
	                                        "p",
	                                        null,
	                                        (0, _moment2.default)(order.paymentTimestamp).format("YYYY-MM-DD H:mm")
	                                    )
	                                ),
	                                React.createElement(
	                                    "section",
	        ...
	        _timeRemaining: function _timeRemaining(paymentTimestamp) {
	            var dueDate = (0, _moment2.default)(paymentTimestamp).add(1, "d").subtract(90, "m");
	            var timeLeft = _moment2.default.duration(dueDate.valueOf() - (0, _moment2.default)().valueOf());
